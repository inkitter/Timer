Timer with Auto Keypress Tip

1.右键弹出菜单可以置顶窗口、取消置顶后窗口的半透明化。右键菜单可以设置备注，用于启动多个Timer窗口记录计时器用途。双击计时时间的部分可缩小窗口。
...
9.start.wav，stop.wav为开始和停止自动按键的声音文件。Timer.ini为配置储存文件。